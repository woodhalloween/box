...
class MetricsCalculator:
    ...
    @staticmethod
    def calculate_frame_level_metrics(ground_truth: List[DetectionResult],
                                      predictions: List[DetectionResult],
                                      total_frames: int,
                                      event_type: str = None) -> Dict[str, float]:
        """
        フレーム単位の評価指標を計算
    ...
    @staticmethod
    def calculate_event_level_metrics(ground_truth: List[DetectionResult],
                                      predictions: List[DetectionResult],
    ...
    @staticmethod
    def calculate_temporal_overlap(ground_truth: List[DetectionResult],
                                   predictions: List[DetectionResult],
                                   event_type: str = None) -> Dict[str, float]:
        """
        時間的重なりの統計を計算
    ...
    def print_metrics(metrics: Dict[str, float], title: str = "Metrics"):
        ...
        # パーセンテージで表示する項目
        percentage_keys = ['precision', 'recall', 'f1_score', 'accuracy', 
                          'mean_iou', 'overlap_ratio_gt', 'overlap_ratio_pred']
...
def main():
    ...
    # フレーム単位の評価
    frame_metrics = calculator.calculate_frame_level_metrics(
        ground_truth, predictions, total_frames
    )
    calculator.print_metrics(frame_metrics, "Frame-Level Metrics")
    
    # イベント単位の評価
    event_metrics = calculator.calculate_event_level_metrics(
